...
def main():
    ...
    if n_train_reqd > 0:
        ...
        idx_shuffle_all = np.arange(Z_XY_partitioned_dict['dataX'].shape[0])
        np.random.shuffle(idx_shuffle_all)
        idx_train_reqd = idx_shuffle_all[:n_train_reqd]
        print("Training indices: {}".format(idx_train_reqd))
        Z_XY_partitioned_dict['dataX'] = Z_XY_partitioned_dict['dataX'][idx_train_reqd, :]
        Z_XY_partitioned_dict['dataY'] = Z_XY_partitioned_dict['dataY'][idx_train_reqd, :]
        Z_XY_partitioned_dict['dataCw'] = Z_XY_partitioned_dict['dataCw'][idx_train_reqd, :]
        Z_XY_partitioned_dict['trajectory_lengths'] = Z_XY_partitioned_dict['trajectory_lengths'][idx_train_reqd, :]
        Z_XY_partitioned_dict['num_samples'] = Z_XY_partitioned_dict['dataX'].shape[0]
