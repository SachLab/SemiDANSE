...
if __name__ == "__main__":
    ...
    smnr_dB_nominal_arr = np.array([10.0])

    for smnr_dB_nominal in smnr_dB_nominal_arr:
        nsup = 20
        kappa = nsup / N_train
        ...
        if mode == 'low' or mode == 'high':
            ...
            bias = None
            p = None
            evaluation_mode = 'full_opt_diff_smnr_dB_kappa_{:.2f}_sigma_e2_{}dB_Ntrain_{}_Ttrain_{}_smnr_dB_nominal_{}dB'.format(nsup/N_train, sigma_e2_dB_test, N_train, T_train, smnr_dB_nominal)
        ...
        #figs_dir = "figs_new_{}_diff_smnr_dB".format(str(datetime.date.today()))
        figs_dir = "figs_new_2024-12-04_diff_smnr_dB_matched"
        ...
        for key in model_file_saved_dict.keys():
            for j, smnr_dB_label in enumerate(smnr_dB_dict_arr):
                ...
                if "matched" in figs_dir:
                    ...
                    if saved_model == "danse_semisupervised" and not nsup is None:
                        model_file_saved_dict[key][smnr_dB_label] = glob.glob("./models/*{}_{}_*nsup_{}_m_{}_n_{}_*T_{}_N_{}*sigmae2_{}dB_smnr_{}dB*/*best*".format(
                            ssmtype, saved_model, nsup, m, n, T_train, N_train_actual, sigma_e2_dB_test, smnr_dB_nominal))[-1]
                    elif saved_model == "KNetUoffline":
                        model_file_saved_dict[key][smnr_dB_label] = glob.glob("./models/*{}_{}_*m_{}_*n_{}_*T_{}_N_{}*sigmae2_{}dB_smnr_{}dB*/*best*".format(
                            ssmtype, saved_model, m, n, T_train, N_train_actual, sigma_e2_dB_test, smnr_dB_nominal))[-1]
                    else:
                        model_file_saved_dict[key][smnr_dB_label] = glob.glob("./models/*{}_{}_*opt_gru_m_{}_*n_{}_*T_{}_N_{}*sigmae2_{}dB_smnr_{}dB*/*best*".format(
                            ssmtype, saved_model, m, n, T_train, N_train_actual, sigma_e2_dB_test, smnr_dB_nominal))[-1]

        test_logfile = "./{}/{}/{}/{}_test_{}_nsup_{}_T_{}_N_{}_diff_smnr.log".format(figs_dir, dirname, evaluation_mode, ssmtype, evaluation_mode, nsup, T_test, N_test)
        test_jsonfile = "./{}/{}/{}/{}_test_{}_nsup_{}_T_{}_N_{}_diff_smnr.json".format(figs_dir, dirname, evaluation_mode, ssmtype, evaluation_mode, nsup, T_test, N_test)

        print(model_file_saved_dict)

        for idx_kappa, smnr_dB_label in enumerate(smnr_dB_dict_arr):
