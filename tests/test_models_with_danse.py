...
if __name__ == "__main__":
    ...
    for nsup in nsup_arr:
        ...
        figs_dir = "figs_new_2026-1-5_danse_semidanse_w_ablation" #"figs_new_{}_danse_semidanse".format(str(datetime.date.today()))
        ...
        list_of_models_comparison = ["ls", "ukf", "ekf", "danse", "dmm_st-l", "danse_supervised", "danse_semisupervised"]
